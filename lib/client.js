...
.hbt-dock-body { margin: 2px 6px 6px; padding-top: 5px; border-top: 1px solid var(--dsw-alias-border-l1); }
.hbt-dock-stream { max-height: 140px; }
...
`;
    ...
    function StreamingToolDock(props) {
      ...
      if (stream) {
        if (name === "bash") {
          body = e("div", { className: "hbt-dock-body", key: "body" },
            e("div", { className: "hbt-term" },
              e("pre", { className: "hbt-term-out hbt-dock-stream" }, "$ " + stream + "\n▍")));
        } else {
          var t = tailLines(stream, 6);
          body = e("div", { className: "hbt-dock-body", key: "body" },
            e("pre", { className: "hbt-pre hbt-dock-stream" }, (t.hidden > 0 ? "… 前略 " + t.hidden + " 行\n" : "") + t.text + "\n▍"));
        }
      }
