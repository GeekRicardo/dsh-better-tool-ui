...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var TOOL_META = {
      ...
      ask_user_question: { label: "AskUser", desc: "向用户提问", icon: "send" },
...
`;
    ...
    function apply(ctx) {
      ...
      ctx.slots.inject("tool.call.toolview", function () {
        ...
        var rowKeys = ["bash", "read", "write", "edit", "grep", "glob", "web_search", "web_fetch", "todo_write", "skill", "job_output", "job_list", "job_kill", "subagent", "subagent_fork", "list_agents", "send_message", "validate_dsh_ui", "str_replace_editor", "workflow", "interrupt_agent", "report", "pwsh", "ralph", "read_image", "notebook_edit", "exit_plan_mode"];
      ...
      ctx.slots.inject("conversation.chat.streamingCall", function () {
        ...
        var streamKeys = ["bash", "read", "write", "edit", "grep", "glob", "web_search", "web_fetch", "todo_write", "skill", "job_output", "job_list", "job_kill", "subagent", "subagent_fork", "list_agents", "send_message", "validate_dsh_ui", "str_replace_editor", "workflow", "interrupt_agent", "report", "pwsh", "ralph", "read_image", "notebook_edit", "exit_plan_mode", "create_goal", "get_goal", "update_goal"];
        var disposers = [];
